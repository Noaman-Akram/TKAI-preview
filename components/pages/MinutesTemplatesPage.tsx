...
export function MinutesTemplatesPage() {
  ...
  const templates = [
    {
      id: 1,
      name: 'محضر اجتماع أساسي',
      category: 'meeting',
      description: 'قالب أساسي لمحاضر الاجتماعات',
      lastUsed: '2024-01-15',
      isStarred: true,
    ...
    {
      id: 2,
      name: 'محضر مجلس إدارة',
      category: 'board',
      description: 'قالب شامل لمحاضر مجالس الإدارة',
      lastUsed: '2024-01-14',
      isStarred: false,
      content: '# محضر مجلس الإدارة\n\n## الحضور\n...'
    },
    {
      id: 3,
      name: 'محضر لجنة سريع',
      category: 'committee',
      description: 'قالب مختصر لمحاضر اللجان',
      lastUsed: '2024-01-13',
      isStarred: true,
      content: '# محضر اللجنة\n\n## القرارات\n...'
    },
    {
      ...
      name: 'ملخص ورشة عمل',
      category: 'workshop',
      description: 'قالب لتلخيص ورش العمل',
      lastUsed: '2024-01-12',
      isStarred: false,
      content: '# ملخص ورشة العمل\n\n## الأهداف\n...'
    },
  ];

  const categories = [
    { id: 'all', name: 'الكل' },
    { id: 'meeting', name: 'اجتماعات' },
    { id: 'board', name: 'مجالس إدارة' },
    { id: 'committee', name: 'لجان' },
    { id: 'workshop', name: 'ورش عمل' },
  ];
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.subtitle}>إدارة وتنظيم قوالب المحاضر والاجتماعات</Text>
          </View>
        </View>
